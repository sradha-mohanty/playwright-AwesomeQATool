...
export class QATool{
      ...
      async checkTextOfQnA(data){
        ...
        value=await element.textContent();
          ...
          expect(value).toEqual(data.question+data.answer)
        }
        //console.log(value)
      ...
      async sortQuestions(){
        ...
        //console.log("Before Sorting:"+questionListBeforeSort);
        ...
        //console.log("Before Sorting:"+questionListBeforeSort);
        //console.log("After Sorting:"+questionListAfterSort);
    ...
    async checkToolTip(){
      ...
      let toolTipCreateNewQuestion=this.page.locator("//div[@class='question-maker']").locator("//h2[@class='tooltipped-title__title']");
        ...
        //console.log(toolTipCreatedQuestionLocator);
        ...
        //console.log(toolTipCreateNewQuestionLocator);
